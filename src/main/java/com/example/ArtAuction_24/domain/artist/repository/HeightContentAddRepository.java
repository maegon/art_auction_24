...
import com.example.ArtAuction_24.domain.artist.entity.HeightContentAdd;
import org.springframework.data.jpa.repository.JpaRepository;

public interface HeightContentAddRepository extends JpaRepository<HeightContentAdd, Long> {
