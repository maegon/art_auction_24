    ...
    CommandLineRunner init(MemberService memberService, ArtistService artistService, ProductService productService) {
        ...
        return args -> {
            ...
            if (!productService.existsByTitleAndArtist("토끼", artist1)) {
                productService.create("토끼", "이 그림은 부드러운 색조와 섬세한 디테일로 그려진 귀여운 토끼를 담고 있습니다. 토끼의 큰 눈과 푹신한 털은 따뜻하고 아늑한 느낌을 주며, 자연 속에서 조용히 쉬고 있는 모습을 표현했습니다. 그림 속 토끼는 순수하고 순진한 매력을 지니고 있어, 보는 이로 하여금 평화롭고 행복한 감정을 느끼게 합니다. 이 작품은 자연과 동물의 아름다움을 경이롭게 담아내려는 저의 노력의 결과입니다.", "색연필", 90, 128, new BigDecimal(10000), LocalDateTime.now(), "image/product/product_paint_2.jpg", "수채화", artist1);
            }
            if (!productService.existsByTitleAndArtist("은하계", artist2)) {
                productService.create("은하계", "이 그림은 광활한 우주를 배경으로 한 은하계를 담아낸 작품입니다. 별들이 수놓은 밤하늘과 그 사이를 흐르는 은하의 신비로운 모습이 아름답게 표현되어 있습니다. 색다른 색조와 반짝이는 별빛, 그리고 깊은 우주의 신비로움이 조화를 이루며 관객을 우주의 끝없는 광활함 속으로 초대합니다. 이 작품은 우주의 웅장함과 아름다움을 탐구하고, 무한한 상상의 세계를 경험하게 해주는 저의 창의력의 표현입니다..", "종이에 물감", 600, 300, new BigDecimal(11000), LocalDateTime.now(), "image/product/product_paint_4.jpg", "수채화", artist2);
            }
            if (!productService.existsByTitleAndArtist("천사와 악마", artist3)) {
                productService.create("천사와 악마", "이 그림은 천사와 악마의 대비를 통해 인간 내면의 갈등과 도덕적 이중성을 탐구한 작품입니다. 천사는 순수함과 희망의 상징으로, 부드럽고 따뜻한 색조로 표현되어 있습니다. 반면, 악마는 어두운 색상과 날카로운 선들로 그려져 있으며, 위협적이고 강렬한 존재감을 드러냅니다. 두 캐릭터의 극명한 대조는 선과 악, 빛과 어둠 간의 끊임없는 싸움을 시각적으로 드라마틱하게 담아내며, 인간의 도덕적 선택과 그에 따른 내적 갈등을 관객에게 깊이 있게 전달합니다.", "종이에 물감", 30, 20, new BigDecimal(12000), LocalDateTime.now(), "image/product/product_paint_3.jpg", "수채화", artist3);
            }
            if (!productService.existsByTitleAndArtist("산", artist4)) {
                productService.create("산", "이 그림은 장엄한 산의 풍경을 통해 자연의 위대함과 평화를 표현하고 있습니다. 높은 산봉우리가 구름을 뚫고 하늘에 닿아 있으며, 그 위로 펼쳐진 푸른 하늘과 산의 웅장한 실루엣이 돋보입니다. 산의 거친 표면과 부드러운 구름의 조화는 자연의 강인함과 동시에 그 속에서 느껴지는 평온함을 함께 전달합니다. 이 작품은 보는 이에게 자연의 신비롭고 장대한 아름다움을 경험할 수 있는 기회를 제공합니다.", "종이에 물감", 128, 85, new BigDecimal(13000), LocalDateTime.now(), "image/product/product_paint_6.jpg", "수채화", artist4);
            }
            if (!productService.existsByTitleAndArtist("노란머리여자", artist5)) {
                productService.create("노란머리여자 ", "이 작품은 노란 머리를 가진 여성의 초상화를 통해 개성과 독특함을 강조합니다. 여성의 머리카락은 밝고 눈에 띄는 노란색으로 칠해져 있으며, 이는 작품의 중심적인 시각적 요소로 작용합니다. 그녀의 표정은 자신감과 매력을 뽐내며, 배경의 단순화된 색조와 대조를 이루어 주목도를 높입니다. 이 그림은 현대적이고 신선한 감각을 전달하며, 개성과 스타일을 표현하는데 중점을 둡니다.", "종이에 물감", 93, 128, new BigDecimal(14000), LocalDateTime.now(), "image/product/product_paint_10.jpg", "수채화", artist5);
            }
            if (!productService.existsByTitleAndArtist("슬픈사람", artist6)) {
                productService.create("슬픈사람", "이 작품은 깊은 감정의 표현을 통해 슬픔을 시각적으로 담아낸 초상화입니다. 주인공의 얼굴에는 절망과 상실의 흔적이 명확하게 드러나며, 어두운 색조와 감정적인 구도로 그 분위기를 한층 강조합니다. 눈빛은 슬픔을 고백하는 듯하며, 고요하고 침착한 표정 속에 복잡한 감정이 숨겨져 있습니다. 배경은 단순화되어 있어 인물의 감정에 집중할 수 있도록 돕습니다. 이 그림은 인간의 내면의 고통과 감정을 세심하게 표현하여 보는 이로 하여금 깊은 공감을 일으키게 합니다.", "종이에 물감", 90, 128, new BigDecimal(15000), LocalDateTime.now(), "image/product/product_paint_5.jpg", "수채화", artist6);
            }
            if (!productService.existsByTitleAndArtist("눈", artist1)) {
                productService.create("눈", "이 작품은 단순한 형태의 눈을 통해 깊은 감정을 표현한 초상화입니다. 섬세하게 그려진 눈동자는 보는 이로 하여금 감정의 미세한 변화를 읽을 수 있게 해줍니다. 눈의 윤곽과 세밀한 디테일은 인간의 내면 깊숙한 곳까지 들여다볼 수 있는 창을 제공합니다. 강렬한 색조와 명암 대비는 눈의 감정적 강도를 강조하며, 간결한 배경은 감상의 집중을 돕습니다. 이 그림은 시각적으로 감정을 전하며, 보는 이에게 깊은 인상을 남깁니다.", "종이에 색연필과 물감", 128, 85, new BigDecimal(60000), LocalDateTime.now(), "image/product/product_paint_11.jpg", "수채화", artist1);
            }
            if (!productService.existsByTitleAndArtist("땅하늘우주", artist2)) {
                productService.create("땅하늘우주", "이 작품은 자연과 우주를 아우르는 광대한 경관을 시각적으로 풀어낸 걸작입니다. 하늘과 땅, 우주가 유기적으로 연결된 이 그림은 지구의 고요한 풍경부터 시작하여, 끝없이 펼쳐진 하늘과 별들이 가득한 우주를 배경으로 삼아 마치 모든 것이 하나로 엮여 있는 듯한 느낌을 줍니다. 땅의 구석구석은 현실적이고 섬세하게 묘사되며, 하늘은 푸르고 깊은 색조로 그려져 우주와의 경계를 희미하게 만들어, 우주 속의 무한한 가능성과 신비로움을 상기시킵니다. 이 그림은 자연과 우주의 조화로운 만남을 통해 감상자에게 경이롭고 평화로운 감정을 선사합니다.", "종이에 물감", 21, 30, new BigDecimal(100000), LocalDateTime.now(), "image/product/product_paint_8.jpg", "수채화", artist2);
            }
            if (!productService.existsByTitleAndArtist("바다", artist3)) {
                productService.create("바다", "이 그림은 무한한 바다의 광활함과 평온함을 담아낸 작품입니다. 해안선을 따라 펼쳐진 푸른 바다는 끝없는 자유와 여유를 상징하며, 파도의 부드러운 곡선과 섬세한 색감이 자연의 아름다움을 강조합니다. 태양의 반사와 물결의 흐름은 생동감을 더하며, 수평선에서 만나는 하늘과 바다는 무한한 상상의 공간을 제공합니다. 이 작품은 바다의 평화롭고 동시에 강렬한 에너지를 시각적으로 표현하여 감상자에게 깊은 힐링을 선사합니다.", "종이에 물감", 128, 90, new BigDecimal(500000), LocalDateTime.now(), "image/product/product_paint_7.jpg", "수채화", artist3);
            }
